...
//        }        
    ...
    handleRowAction: function (component, event, helper) {
        ...
        switch (action.name) {
            case 'editRecord':
                console.log('edit');
                let mylist = ['firstname','lastname','email'];
                let parms = helper.getURLParams(component,mylist);
                let queryString = '';
                ...
                urlEvent.setParams({
                  "url": "/?BrokerId=" + row.Id +queryString
                });
                urlEvent.fire();
                break;
                /*let firstname;
                if(!localStorage.getItem('firstname')) {
                    ...
                    for (let i = 0; i < sURLVariables.length; i++) {
                        ...
                        firstname = sParameterName[1] === undefined ? true : sParameterName[1];
                ...
                urlEvent.setParams({
                  "url": "/?BrokerId=" + row.Id + "&firstname=" +firstname
                });
                urlEvent.fire();
               // helper.goToLineItem(component,event,row.prevName);
                break;*/
                //let parms =[firstname,lastname, email];
